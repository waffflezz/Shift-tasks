...
@Fork(1)
@State(Scope.Thread)
public class FixedExecutorTuningBenchmark {
    @Param({"powers-of-two"})
    ...
    @Param({"1", "2", "4", "8", "16", "32", "64", "100", "256"})
    ...
    public void setUp() {
        ...
        solver = new FixedExecutorSeriesSolver(poolSize, taskCount);
    }

    @Benchmark
    public double fixedExecutor() {
